...
class _UsersCard extends StatelessWidget {
  ...
  const _UsersCard({required this.users, required this.onExportTap});
            ...
            children: [
              pw.TableRow(
                children: [
                  ...
                  pw.Padding(
                      padding: const pw.EdgeInsets.all(8),
                      child: pw.Text('البريد الإلكتروني',
                          style: pw.TextStyle(
                              font: arabicFont,
                              fontWeight: pw.FontWeight.bold))),
                  pw.Padding(
              ...
              ...users.map((user) {
                return pw.TableRow(children: [
                  ...
                  pw.Padding(
                      padding: const pw.EdgeInsets.all(8),
                      child: pw.Text(user.phone,
                          style: pw.TextStyle(font: arabicFont))),
                  pw.Padding(
                      padding: const pw.EdgeInsets.all(8),
                      child: pw.Text(user.type.label,
                          style: pw.TextStyle(font: arabicFont))),
                  pw.Padding(
                      padding: const pw.EdgeInsets.all(8),
                      child: pw.Text(user.region,
                          style: pw.TextStyle(font: arabicFont))),
                ]);
              }),
            ],
